...
#"eta", also known as the learning rate.
...
for curr_val in eta_vals:
    ...
    # Perform cross-validation: cv_results
    cv_results = xgb.cv(dtrain=housing_dmatrix, params=params, nfold=3, num_boost_round=10, metrics="rmse" ,early_stopping_rounds=5, as_pandas=True, seed=123)
...
for curr_val in max_depths:
    ...
    cv_results = xgb.cv(dtrain=housing_dmatrix, params=params, nfold=2, num_boost_round=10, metrics="rmse" ,early_stopping_rounds=5, as_pandas=True, seed=123)
