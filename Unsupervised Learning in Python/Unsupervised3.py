...
grains=pd.read_csv('data/seeds-width-vs-length.csv',header=None).values
...
second_pc = model.components_[1,:]/2
...
#%%
# =============================================================================
#  (samples-samples.mean(axis=0))/samples.std(axis=0) = scaled_samples
#   for each column(features) we preform subtract the mean and divided by the std
# =============================================================================
